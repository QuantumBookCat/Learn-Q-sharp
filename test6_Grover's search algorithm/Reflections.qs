namespace Quantum.Grover {
    ...
    operation ReflectAboutMarked(inputQubits : Qubit[]) : Unit {
        ...
        using (outputQubit = Qubit()) {
            within {
                ...
                // ApplyToEachA operation : Applies a single-qubit operation to each element in a register. 
    ...
    operation PrepareUniform(inputQubits : Qubit[]) : Unit is Adj + Ctl {
        ...
        // ApplyToEachCA operation : Applies a single-qubit operation to each element in a register. 
    }
